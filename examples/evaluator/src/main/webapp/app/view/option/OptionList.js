    ...
    alias: 'widget.optionlist',
        ...
        hideSearchPanel: true,
             ...
             columns: [{
                ...
                text: 'Balanced Score (Absolute)',
                dataIndex: 'balancedScorePC',
                xtype: 'widgetcolumn',
                reference: 'balancedCol',
                widget: {
                    xtype: 'progressbarwidget',
                    textTpl: ['&nbsp{percent:number("0")}%']
                },
                ...
                text: 'Balanced Score (Relative)',
                dataIndex: 'relativeBalancedScorePC',
                xtype: 'widgetcolumn',
                reference: 'relBalancedCol',
                widget: {
                    xtype: 'progressbarwidget',
                    textTpl: ['&nbsp{percent:number("0")}%']
                },
                ...
                items: [{
                        ...
                        handler: 'onOptionListButton',
                        tooltip: 'View scores for this option'
                }]
            }],
